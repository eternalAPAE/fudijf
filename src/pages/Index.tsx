...
const Index = () => {
  ...
  const members = [
    ...
    { name: "rias", role: "Coder/Support", image: "https://files.catbox.moe/pkrjlz.png", telegram: "@poorint", quote: "I took a second out my day to calm the fuck down, now i got one less second to do something what the fuck now" },
    ...
    { name: "faint", role: "Co Owner", image: "https://files.catbox.moe/btdwru.jpg", telegram: "@faintend", quote: "open source intelligence" },
